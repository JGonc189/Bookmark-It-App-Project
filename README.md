This app was a simple project using vanilla JS and HTML5 Local Storage.  The app allows the user to type in a website and then save it for a future reference. 
